...
class CNN:
    ...
    def __init__(self, alpha, batch_size, num_classes, penalty_parameter, sequence_length):
        """Initializes the CNN-ReLU model
        ...
        def __graph__():
            ...
            dense_layer_activation = tf.nn.leaky_relu(tf.matmul(second_conv_pool_flatten, dense_layer_weight)
                                                      + dense_layer_bias)
            ...
            with tf.name_scope('metrics'):
                predicted_class = tf.nn.relu(logits)
